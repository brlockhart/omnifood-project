...
- Logo + Navigation
- Hero
- Featured in (usually right after the hero or even in the hero)
- How it works (with 3 big app images/screenshots)
- Meals (and list of diets)
- Testimonials + Gallery
- Pricing (pricing is usually low on the page. can possibly + with features)
- Features (moved down the list because the 'features' information is mostly secondary and less important)
- CTA (usually last section before the footer)
- Footer
